...
tbl_lifetables <- readr::read_csv(file=here::here("data/lifetables.csv.gz"),
                                  show_col_types = FALSE)
...
tbl_lifetables |> 
  ...
  # Add a line and step and check the graph to note difference
  # Add a step layer
  geom_step() +
  # Add labels (title, subtitle, x, y, caption)
  labs(
    title = "Survival Curve for a person to be alive in 2022",
    subtitle = "Females have better probability of survival compared to males",
    x = "Year",
...
tbl_lifetables_extended <- tbl_lifetables |> 
  ...
  # you can filter by gender and age, filter(sex=='F', age==25)
...
tbl_lifetables_extended_2022 |> 
 ...
 geom_line() +
  ...
  # Add labels (title, subtitle, x, y, caption)
  labs(
    title = "Survival Curve for a person that survived 2022",
    subtitle = "Females have better probability of survival compared to males",
    x = "Year",
    y = "Probability of Survival",
    caption = "Source: SSA"
...
# |> filter(name=='Mary', year>1950, year<1980)
```
